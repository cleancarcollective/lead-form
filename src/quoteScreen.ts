...
const IC = {
  ...
  sliders: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 8h8M18 8h2M4 16h2M12 16h8"/><circle cx="15" cy="8" r="2.4"/><circle cx="9" cy="16" r="2.4"/></svg>',
  plusCircle: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 8.2v7.6M8.2 12h7.6"/></svg>',
...
.ccc-estimate{box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#0a0a0a;background:#ffffff;line-height:1.5;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;width:100%;margin:0;padding:32px 24px 40px}
...
.ccc-reviews{display:flex;flex-direction:column;align-items:center;text-align:center;gap:7px;border:1px solid #d0d0d0;border-radius:16px;padding:18px 18px 16px;background:linear-gradient(158deg,#ffffff 0%,#f5f5f5 52%,#ececec 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.9),0 8px 26px rgba(0,0,0,.13);margin-bottom:14px}
...
.ccc-card{position:relative;border:1px solid #d0d0d0;border-radius:16px;background:#fff;padding:20px 18px 18px;display:flex;flex-direction:column;box-shadow:0 2px 10px rgba(0,0,0,.06);transition:transform .14s ease,box-shadow .14s ease,border-color .14s ease}
.ccc-card--std:hover{border-color:#0a0a0a;transform:translateY(-3px);box-shadow:0 12px 30px rgba(0,0,0,.14)}
.ccc-card--feat{border:1.5px solid #0a0a0a;box-shadow:0 8px 28px rgba(0,0,0,.16)}
.ccc-card--feat:hover{transform:translateY(-3px);box-shadow:0 14px 38px rgba(0,0,0,.22)}
...
.ccc-rule{height:1px;background:#e5e5e5;margin:15px 0 13px}
...
.ccc-note{display:flex;align-items:flex-start;gap:10px;padding:13px 15px;border:1px solid #d0d0d0;border-radius:12px;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,.05);font-size:13px;color:#444;line-height:1.45}
...
.ccc-more{margin-top:10px;padding:15px 16px 16px;border:1px solid #d0d0d0;border-radius:12px;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,.05)}
...
.ccc-git{margin-top:10px;padding:15px 16px 16px;border:1px solid #d0d0d0;border-radius:12px;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,.05)}
...
export function buildQuoteHtml(
  ...
  <div class="ccc-reviews" role="group" aria-label="Google reviews">
    ...
    <div class="ccc-rv-count">Based on <strong>250+ reviews</strong></div>
  ...
  <div class="ccc-notes">
    <div class="ccc-note">${IC.sliders}<span><strong>Every package can be tailored to your car.</strong> Just mention what you need when you book.</span></div>
  </div>
  <div class="ccc-more">
    <div class="ccc-more-label">${IC.plusCircle} Want something else?</div>
